class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('proto');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.proto.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.proto.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'proto'){
                    geotab.addin.proto.blur();
                } else {
                    geotab.addin.proto.focus(global.api, global.state);
                }
            }
        }, 100);
    }
